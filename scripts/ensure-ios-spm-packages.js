...
const packages = [
  {
    packageName: '@numbersprotocol/preview-camera',
    productName: 'NumbersprotocolPreviewCamera',
    targetName: 'PreviewCameraPlugin',
    sourcePath: 'ios/Plugin',
    spmPath: 'ios/Sources/PreviewCameraPlugin',
    className: 'PreviewCameraPlugin',
    ...
    methods: [
      ...
      ['setFlashModes', 'promise'],
      ['isTorchOn', 'promise'],
      ['enableTorch', 'promise'],
      ['isTorchAvailable', 'promise'],
      ['focus', 'promise'],
      ['minAvailableZoom', 'promise'],
      ['maxAvailableZoom', 'promise'],
      ['zoom', 'promise'],
      ['setQuality', 'promise'],
      ['saveFileToUserDevice', 'promise'],
  ...
  {
    packageName: '@numbersprotocol/preview-video',
    productName: 'NumbersprotocolPreviewVideo',
    targetName: 'PreviewVideoPlugin',
    sourcePath: 'ios/Plugin',
    spmPath: 'ios/Sources/PreviewVideoPlugin',
    className: 'PreviewVideoPlugin',
    jsName: 'PreviewVideo',
    methods: [
      ['echo', 'promise'],
      ['playFullScreenFromRemote', 'promise'],
      ['stopFullScreen', 'promise'],
      ['method3', 'callback'],
    ],
    dependencies: [],
  },
